...
- **IAP (Índice de Adesão e Percepção):** Monitoramento de engajamento das redes.
- **IEI (Índice de Eficiência de Infraestrutura):** Mapeamento de prontidão tecnológica via Censo 2025.
- **Evolução Pedagógica:** Análise de tendência das notas do IDEB por etapa de ensino.
